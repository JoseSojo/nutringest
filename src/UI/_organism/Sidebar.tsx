...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div className="static flex lg:hidden flex-col items-center w-16 h-full dark:text-gray-400 dark:bg-emerald-900 min-h-screen">
            ...
            <div className="hidden lg:grid w-56 h-full bg-emerald-300 text-gray-800 dark:text-gray-100 dark:bg-emerald-700 min-h-screen"></div>

            <div className="hidden lg:grid w-48 h-full fixed bg-emerald-300 text-gray-800 dark:text-gray-100 dark:bg-emerald-700 min-h-screen">
