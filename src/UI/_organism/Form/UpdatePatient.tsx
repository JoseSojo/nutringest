                ...
                <div className="grid grid-cols-12 p-2 gap-2">
                    ...
                    <div className="col-span-12 grid lg:grid-cols-2 mt-4 p-2 gap-5">
                        ...
                        <div className="col-span-2 grid grid-cols-12 gap-2 border rounded">
                            ...
                            <InputDefPatient value={habitosAlimentacion && habitosAlimentacion[`Hace colaciones`] ? habitosAlimentacion[`Hace colaciones`] : ``} change={HandleChangeHabitosAlimentacion} name="hace_colaciones" label="Hace colaciones" cols="col-span-3" type="text" placeholder="Escribir aquí" />
                        ...
                        <div className="col-span-2 grid gap-2 border rounded">
                            ...
                            <InputDefPatient value={redordatorio24Horas && redordatorio24Horas[`Colación Matutina`] ? redordatorio24Horas[`Colación Matutina`] : ``} change={HandleChangeRedordatorio24Horas} name="colacion" label={"Colación Matutina"} cols="" type="text" placeholder="Escribir aquí" />
                            ...
                            <InputDefPatient value={redordatorio24Horas && redordatorio24Horas[`Colación`] ? redordatorio24Horas[`Colación`] : ``} change={HandleChangeRedordatorio24Horas} name="colacion" label={"Colación"} cols="" type="text" placeholder="Escribir aquí" />
                        ...
                        <div className="grid grid-cols-12 gap-2 border rounded">
                            ...
                            <InputDefPatient value={indicadorAntropometico && indicadorAntropometico[`IMC: Peso meta`] ? indicadorAntropometico[`IMC: Peso meta`] : ``} change={HandleChangeIndicadorAntropometico} name="imc_peso_meta" label="IMC: Peso meta" cols="col-span-6" type="text" placeholder="Escribir aquí" />
                        </div>
