...
export default function AbstractRemove({ crud,reload,pathGui,query }: Props) {
    ...
    const HandleDelete = async (e: FormEvent) => {
        e.preventDefault();
        const url = `${API}/${pathGui ? pathGui :crud}/remove/${query ? `?${query}` : ``}`;
            ...
            <div className="relative z-50 flex justify-center items-center w-full">
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    <form onSubmit={HandleDelete} className="relative p-4 text-center bg-white rounded-lg shadow drk:bg-gray-800 sm:p-5">
                        ...
                        <p className="mb-4 text-gray-500 drk:text-gray-300">Seguro que desea remover el registro?</p>
