...
export default function Footer () {
    ...
    return (
        <footer className="bg-white drk:bg-gray-800">
                <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                    <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase drk:text-white">Company</h3>
                            <ul className="text-gray-500 drk:text-gray-400">
                                <li className="mb-4">
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase drk:text-white">Help center</h3>
                            <ul className="text-gray-500 drk:text-gray-400">
                                <li className="mb-4">
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase drk:text-white">Legal</h3>
                            <ul className="text-gray-500 drk:text-gray-400">
                                <li className="mb-4">
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase drk:text-white">Download</h3>
                            <ul className="text-gray-500 drk:text-gray-400">
                                <li className="mb-4">
                    ...
                    <div className="text-center">
                        ...
                        <span className="block text-sm text-center text-gray-500 drk:text-gray-400">© 2021-2022 Landwind™. All Rights Reserved. Built with <a href="https://flowbite.com" className="text-purple-600 hover:underline drk:text-purple-500">Flowbite</a> and <a href="https://tailwindcss.com" className="text-purple-600 hover:underline drk:text-purple-500">Tailwind CSS</a>.
                        </span>
                        <ul className="flex justify-center mt-5 space-x-5">
                            <li>
                                <a href="#" className="text-gray-500 hover:text-gray-900 drk:hover:text-white drk:text-gray-400">
